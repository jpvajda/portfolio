  ...
  return (
    <Carousel className="carousel">
      <Carousel.Item>
        ...
        <Carousel.Caption >
          <h3>Hello!</h3>
          <p className="carouselText">I am product and engineering leader who loves to code. I have 15 years of technical
          project and technical product management experience, and over the last 5 years been
